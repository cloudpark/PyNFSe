...
class NFSeSigner:
    ...
    def __init__(self, certificate, key, namespace):
        self.cert = certificate
        self.key = key
        self.namespace = namespace

    def sign_rps_batch(self, rps_batch_xml):
        root = etree.fromstring(rps_batch_xml)
    ...
    def sign_cancellation_request(self, xml_cancellation_request):
        ...
        cancellation_request_signed = etree.tostring(xml_root).decode()
